#!/usr/bin/env python3
"""Generate the PRD for twenty-dollar react-v2."""
import os

os.makedirs('/root/twenty-dollar/react-v2/specs', exist_ok=True)

sections = []

sections.append("""# Product Requirements Document: Twenty-Dollar React v2
...
with open('/root/twenty-dollar/react-v2/specs/01-prd.md', 'w') as f:
    f.write('\n'.join(sections))

print(f"PRD written: {os.path.getsize('/root/twenty-dollar/react-v2/specs/01-prd.md')} bytes")
